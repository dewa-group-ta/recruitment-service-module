...
export class ApplicantsSeeder extends BaseSeeder {
  ...
  private async createApplicants() {
    const sampleData = [
      ...
      {
        fullName: "Bambang Suryadi",
        email: "bambang.suryadi@gmail.com",
        gender: "male",
        maritalStatus: "married"
      },
      {
        fullName: "Rini Wulandari",
        email: "rini.wulandari@yahoo.com",
        gender: "female",
        maritalStatus: "single"
      },
      {
      ...
      {
        fullName: "Lestari Dewi",
        email: "lestari.dewi@gmail.com",
        gender: "female",
        maritalStatus: "married"
      },
      {
      ...
      {
        fullName: "Tiara Safitri",
        email: "tiara.safitri@yahoo.com",
        gender: "female",
        maritalStatus: "single"
      },
      {
      ...
      {
        fullName: "Novia Anggraeni",
        email: "novia.anggraeni@gmail.com",
        gender: "female",
        maritalStatus: "married"
      },
      {
        fullName: "Bagas Kurniawan",
        email: "bagas.kurniawan@gmail.com",
        gender: "male",
        maritalStatus: "single"
      },
      {
        fullName: "Putri Ramadhani",
        email: "putri.ramadhani@yahoo.com",
        gender: "female",
        maritalStatus: "single"
      },
      {
      ...
      {
        fullName: "Diana Puspita",
        email: "diana.puspita@yahoo.com",
        gender: "female",
        maritalStatus: "single"
      },
      {
        fullName: "Reza Fauzi",
        email: "reza.fauzi@gmail.com",
        gender: "male",
        maritalStatus: "single"
      },
      {
        fullName: "Hana Fitriani",
        email: "hana.fitriani@gmail.com",
        gender: "female",
        maritalStatus: "married"
      },
      {
        fullName: "Andre Kusuma",
        email: "andre.kusuma@gmail.com",
        gender: "male",
        maritalStatus: "single"
      },
      {
        fullName: "Mega Pratiwi",
        email: "mega.pratiwi@yahoo.com",
        gender: "female",
        maritalStatus: "single"
      },
      {
        fullName: "Hafiz Ramdhani",
        email: "hafiz.ramdhani@gmail.com",
        gender: "male",
        maritalStatus: "single"
      },
      {
        fullName: "Cindy Octavia",
        email: "cindy.octavia@gmail.com",
        gender: "female",
        maritalStatus: "married"
      },
      {
        fullName: "Rizal Firdaus",
        email: "rizal.firdaus@gmail.com",
        gender: "male",
        maritalStatus: "single"
      },
      {
        fullName: "Vina Amalia",
        email: "vina.amalia@yahoo.com",
        gender: "female",
        maritalStatus: "single"
      },
      {
        fullName: "Taufik Ismail",
        email: "taufik.ismail@gmail.com",
        gender: "male",
        maritalStatus: "married"
      },
      {
        fullName: "Nita Kurnia",
        email: "nita.kurnia@gmail.com",
        gender: "female",
        maritalStatus: "single"
      },
      {
      ...
      {
        fullName: "Winda Sari",
        email: "winda.sari@yahoo.com",
        gender: "female",
        maritalStatus: "married"
      },
      {
        fullName: "Fandi Akbar",
        email: "fandi.akbar@gmail.com",
        gender: "male",
        maritalStatus: "single"
      },
      {
        fullName: "Laras Kinanti",
        email: "laras.kinanti@gmail.com",
        gender: "female",
        maritalStatus: "single"
      },
      {
        fullName: "Galih Prabowo",
        email: "galih.prabowo@gmail.com",
        gender: "male",
        maritalStatus: "single"
      },
      {
        fullName: "Shinta Dewi",
        email: "shinta.dewi@yahoo.com",
        gender: "female",
        maritalStatus: "married"
      }
    ];
