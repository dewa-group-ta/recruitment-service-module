...
export class VacancyController {
  ...
  async update(
    ...
    return this.vacancyService.update(id, updateData, updatedById);
  }
  ...
  @ApiQuery({
    name: "startDate",
    description: "Filter vacancies with startDate on or after this date (YYYY-MM-DD)",
    required: false,
    example: "2024-01-01",
    type: String
  })
  @ApiQuery({
    name: "endDate",
    description: "Filter vacancies with endDate on or before this date (YYYY-MM-DD)",
    required: false,
    example: "2024-12-31",
    type: String
  })
  ...
  @ApiOperation({
    ...
    description: "Set vacancy status to closed."
  })
  @ApiParam({ name: "id", description: "Vacancy ID", example: "uuid-string" })
  ...
  async closeVacancy(
    ...
    const updatedById = req.user?.id || "placeholder-user-id";
    return this.vacancyService.closeVacancy(id, updatedById);
  }
  ...
  @ApiOperation({
    ...
    description: "Set vacancy status to archived."
  })
  @ApiParam({ name: "id", description: "Vacancy ID", example: "uuid-string" })
  ...
  async archiveVacancy(
    ...
    const updatedById = req.user?.id || "placeholder-user-id";
    return this.vacancyService.archiveVacancy(id, updatedById);
  }
