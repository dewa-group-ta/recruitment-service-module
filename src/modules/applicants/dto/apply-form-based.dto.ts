...
export class ExperienceFormDto {
  ...
  @ApiProperty({ enum: EmployeeStatus }) @IsEnum(EmployeeStatus) employeeStatus: EmployeeStatus;
...
export class ApplyFormBasedDto {
  ...
  @ApiProperty({ enum: MaritalStatusEnum }) @IsEnum(MaritalStatusEnum) maritalStatus: MaritalStatusEnum;
  ...
  // Availability
  @ApiProperty({ enum: AvailabilityEnum }) @IsEnum(AvailabilityEnum) availability: AvailabilityEnum;
